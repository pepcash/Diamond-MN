...
1. Clone the github tree to get the source code and go into the directory.
        ...
        git clone https://github.com/LIMXTEC/DMDv3
        cd DMD
...
4. Enter "diamond-qt" as project name, enter src/qt as location
...
Once dependencies are compiled, see release-process.md for how the DMD-Qt.app
...
commands:
    ...
    echo -e "rpcuser=diamondrpc\nrpcpassword=$(xxd -l 16 -p /dev/urandom)" > "/Users/${USER}/Library/Application Support/DMD/diamond.conf"
    chmod 600 "/Users/${USER}/Library/Application Support/DMD/diamond.conf"

The next time you run it, it will start downloading the blockchain, but it won't
output anything while it's doing this. This process may take several hours;
you can monitor its process by looking at the debug.log file, like this:

    tail -f $HOME/Library/Application\ Support/DMD/debug.log
