...
mnbudget prepare \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<diamond_address\> \<monthly_payment_diamond\> [use_ix(true|false)]
...
In this transaction we prepare collateral for "_cool-project_". This proposal will pay _1200_ DMD, _12_ times over the course of a year totaling _24000_ DMD.
...
mnbudget submit \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<diamond_address\> \<monthly_payment_diamond\> \<collateral_hash\>
...
When block `1000000` is reached you'll receive a payment for `1200` DMD.
