...
Setup
---------
Configuring the github-merge tool for the DMD repository is done in the following way:

    git config githubmerge.repository DMD-Project/DMD
...
A script to optimize png files in the DMD
