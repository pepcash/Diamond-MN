...
QString TransactionTableModel::formatTxType(const TransactionRecord* wtx) const
{
    ...
    case TransactionRecord::Generated:
        return tr("Mined");
    case TransactionRecord::mixTXDenominate:
        return tr("mixTX Denominate");
    case TransactionRecord::mixTXCollateralPayment:
        return tr("mixTX Collateral Payment");
    case TransactionRecord::mixTXMakeCollaterals:
        return tr("mixTX Make Collateral Inputs");
    case TransactionRecord::mixTXCreateDenominations:
        return tr("mixTX Create Denominations");
