                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("DMD Diamond Core - Wallet 3.0.1.1") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a DMD address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and diamond: URIs)"));
...
*/
   ...
   // connect(coinmixAction, SIGNAL(triggered()), this, SLOT(gotocoinmixPage()));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About DMD Core"), this);
    aboutAction->setStatusTip(tr("Show information about DMD Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for DMD"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your DMD addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified DMD addresses"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("DMD Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to DMD network", "", count));
}
...
{
    QString strTitle = tr("DMD Core"); // default title
