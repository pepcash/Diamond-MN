                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("mixTX Make Collateral Inputs"), TransactionFilterProxy::TYPE(TransactionRecord::mixTXMakeCollaterals));
    typeWidget->addItem(tr("mixTX Create Denominations"), TransactionFilterProxy::TYPE(TransactionRecord::mixTXCreateDenominations));
    typeWidget->addItem(tr("mixTX Denominate"), TransactionFilterProxy::TYPE(TransactionRecord::mixTXDenominate));
    typeWidget->addItem(tr("mixTX Collateral Payment"), TransactionFilterProxy::TYPE(TransactionRecord::mixTXCollateralPayment));
