    ...
    if (fMasterNode) {
        ...
        BOOST_FOREACH (const CTransaction& txCollateral, vecSessionCollateral) {
            ...
            /*
                ...
                allow endless transaction that would bloat DMD and make it unusable. To
                stop these kinds of attacks 1 in 10 successful transactions are charged. This
                adds up to a cost of 0.001 DMD per transaction on average.
            */
            if (r <= 10) {
...
void CmixTXPool::GetDenominationsToString(int nDenom, std::string& strDenom)
{
    ...
    //
    // bit 0 - 100DMD+1 ( bit on if present )
    // bit 1 - 10DMD+1
    // bit 2 - 1DMD+1
    // bit 3 - .1DMD+1
    // bit 3 - non-denom
