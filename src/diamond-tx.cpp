...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Diamond Core diamond-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  diamond-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded diamond transaction") + "\n" +
                               "  diamond-tx [options] -create [commands]   " + _("Create hex-encoded diamond transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded diamond transaction
