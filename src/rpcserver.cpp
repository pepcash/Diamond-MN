...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Diamond features */
        {"diamond", "masternode", &masternode, true, true, false},
        {"diamond", "masternodelist", &masternodelist, true, true, false},
        {"diamond", "mnbudget", &mnbudget, true, true, false},
        {"diamond", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"diamond", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"diamond", "mnsync", &mnsync, true, true, false},
        {"diamond", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"diamond", "mixTX", &mixTX, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use diamondd, or the -server option to diamond-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> diamond-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:17770/\n";
}
