Contributing to DMD Core
============================

The DMD Core project operates an open contributor model where anyone is
...
The following applies to code changes to the DMD Core project, and is not to be
confused with overall DMD Network Protocol consensus changes.

Whether a pull request is merged into DMD Core rests with the project merge
...
Patches that change DMD consensus rules are considerably more involved than
...
Where a patch set proposes to change the DMD consensus, it must have been
...
The project leader is the release manager for each DMD Core release.
